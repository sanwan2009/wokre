no//1、天书版3.0，极简优化，最终版本，没什么好折腾的了
//2、支持反代开关，私钥开关，全局分段开关，订阅隐藏开关功能，去除UUID限制，clash私钥防止被薅请求数
//3、又再重新修改了接口关闭逻辑，降低请求数（请求数大幅度降低）和错误率（worker引发异常为0，至少我测试的是），CPU超出时间限制会增加一些（不过区别仅仅是原版主动切断，和超时了由CF自动切断的区别）
...
let 哎呀呀这是我的ID啊 = ["9527"]; //这是你的ID，去除UUID规格限制，支持大小写字母和数字任意组合，安全性提高更不容易扫出，就是订阅链接的ID，[域名/ID]进入订阅页面
